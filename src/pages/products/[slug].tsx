    ...
    <div className="container">
            ...
            <ul>
              <li>
                ...
                <div>
                  ...
                  <br />
                  자연의 시간이 흐르며 나무는 나이테와 나무자체의 아름다운 무늬가 생겨납니다. 이에
                  영감을받아 자연에서 나온 천연 옻칠을 이용하여 마호가니를 무늬를 표현하였습니다
                  <br />
                  수많은 사포질과 옻칠 수작업과정을 통해 유기에 아름다움과 실용성을 더하였으며
                  <br />
                  금빛 유기와 마호가니 무늬의 조합은 어떤 음식을 담아도 고급스럽고 멋스럽게
                  연출됩니다.
                </div>
              </li>
              <li>
              ...
              <li>
                ...
                <div>
                  옻칠: 세척 시 거친 수세미를 사용할 경우 표면이 벗겨지거나 손상될 수 있으니
                  부드러운 수세미를 이용해주세요. *유기가 변색된 경우 초록수세미를 이용해 설거지해
                  주시면 원래의 색으로 돌아옵니다.
                </div>
              </li>
              <li>
                <div className="title">NOTICE</div>
                <div>- 전자렌지 사용금지 - 오븐사용금지 - 찬물 식기세척기 사용가능</div>
              </li>
            </ul>
            <div>
              원산지 대한민국
              ...
              배송 방법 택배
              <br />
              배송비 무료 (100,000원 이상 무료배송) |도서산간 배송비 추가 popover
            </div>
          </div>
      ...
      <div>
        ...
        <div className="tab1 content">
          ...
          <br />
          전통 유기에 옻칠을 더한 오브제를 제작하며 전통의 재해석을 시도합니다.
          <br />
